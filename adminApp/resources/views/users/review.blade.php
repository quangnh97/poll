...
<div class="content">
    <div class="row">
        ...
        <div class="col-10 col-right pt-2">
            ...
            <section class='rating-widget' style="width: 500px;margin-left: 300px;">
            ...
            @foreach ($reviews as $review)
                  <tr>
                    ...
                    <td>                  
                      <button data-id="{{$review->id}}" data-target="delete-box" class="show-modal" style="cursor:pointer" >
...
<script>
    $('.show-modal').click(function () {
        ...
        if (targetId == 'delete-box') {
            ...
            $('#form-delete').attr('action', `/reviews-management/${userId}`);
        }
